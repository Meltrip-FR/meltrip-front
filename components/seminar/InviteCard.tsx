    ...
    <div className="flex flex-col px-[13vh] w-full flex-wrap">
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-justify">
          ...
          <b>un quiz de personnalité*</b> à envoyé aux participants du
          séminaire.
        ...
        <div className="mt-16 relative cursor-pointer">
          ...
          <div className="absolute font-bold top-[5.5vh] left-[15vh]">
        ...
        <div className="flex justify-center w-full mt-16">
          <a
            ...
            className="px-6 py-2 text-center font-bold text-white rounded bg-meltrip-primary"
          >
